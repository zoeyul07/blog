...
NFT 이미지는 소유자 뿐만 아니라 모두가 열람이 가능하고 소유자가 아닌 누구나 NFT 이미지를 저장할수도 있고, 저장한 이미지를 다시 판매할 수도 있다. 

NFT를 산다는 것은 이미지를 사는 것이 아닌 이미지와 링크된 데이터를 사는것이기 때문에 만약 링크가 죽고 404 에러가 뜨게 되면 블록체인에 올라갔기 때문에 수정이 불가능하여 아무것도 할수가 없다.
...
게이머들에게 NFT가 중요하게 생각될만한 요소로는 첫번째 재산권(property rights) 두번째로 상호운용성(interoperability)이 있다. 게임사가 해당 계정을 탈퇴시키거나 회사가 망해버리면 게이머가 할 수 있는 것 없이 아이템을 수집하기 위한 모든 노력은 0이 된다. 하지만 게임 아이템들이 NFT가 되면 게이머들이 아이템의 소유주이기 때문에 게임사가 망해도 그 아이템은 여전히 게이머의 지갑에 존재하게 된다.
...
게임사가 망하게 되면 아이템을 소유하더라도 NFT를 소유하는 것에 의미가 사라질 수 있는데 상호 운영성이란 permission-less + public 의 조합으로 누구나 다른 사람이 만든 NFT를 토대로 나만의 게임/앱을 또 다시 만들 수 있다.(e.g. cryptokitties -> kotowars)

NFT는 판매,경매 혹은 다른 거래소로 보내질 수 있고, 대출의 담보로도 사용될 수 있다.(e.g. nftfi/nft를 담보로 이더 혹은 DAI를 대출 받을 수 있다, yield guild games/nft 캐릭터를 빌려 p2e 게임에서 사용하고 돈을 벌면 수익금을 사전에 정한 배분율에 따라 나눈다.)
...
1000불이 있고 그걸로 투자를 하고 싶다면 500개의 BUSD를 사고 500불의 이더리움을 사서 BUSD-ETH 유동성 풀에 넣을 수 있다. 이렇게 하면 다른 사람이 BUSD를 갖고 있는데 ETH를 사고 싶다면 아까의 그 유동성풀을 사용할 수 있게 되고 거래 수수료는 해당 풀의 투자자들에게 돌아간다.

---

### Ref
[블록체인 오라클](https://academy.binance.com/ko/articles/blockchain-oracles-explained)
[decentraland](https://play.decentraland.org)
[nft frame](https://www.creativebloq.com/buying-guides/best-nft-displays)
[nft ticket](https://www.leewayhertz.com/how-nft-ticketing-works/)
[axie infinity](https://axieinfinity.com)
[nft 트위터 프로필](https://biz.chosun.com/international/international_general/2022/01/21/ET2YEXN46RCNHGYRDTNS3FGVE4/)
[crypto kitties](https://www.cryptokitties.co)
[koto wars](https://kotowars.com)
[nftfi](https://www.nftfi.com)
[yield guild games](https://yieldguild.io)
[how does bitcoin mine work](https://www.investopedia.com/tech/how-does-bitcoin-mining-work/)
